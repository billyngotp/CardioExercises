...
function isPalindrome(str) {
  ...
  ///////////////////////
console.log("This is the method I am looking for")
    let isPali = true;
...
// Call Function
const helpme = fizzBuzz();

console.log(helpme);

const testIsPalin = isPalindrome("hello")
console.log("isPalindrome function returns: " + testIsPalin)
